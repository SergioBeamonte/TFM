...
if selected_rep != "Todas (Promedio)":
    ...
    groupby_cols = ['net', 'optimizer', 'fitness_type', 'gen']
...
# Crear columna de leyenda (Experimento)
filtered_df['Experiment'] = filtered_df['net'] + " - " + filtered_df['optimizer'] + " - " + filtered_df['fitness_type']

# Pintar gráfico principal de líneas
fig = px.line(filtered_df, x='gen', y=selected_metric, color='Experiment', 
