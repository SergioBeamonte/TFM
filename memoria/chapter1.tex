...
problems~\cite{bielza2011review} and offer a particularly compact
graphical formalism:
...
To put these numbers in perspective, the SRI elicitation
protocol — still the reference in the field — requires roughly
\emph{thirty minutes per parameter}~\cite{bielza2010modeling},
...
general even harder to elicit: a single utility function with five
...
\end{enumerate}
A wealth of representational extensions has been proposed in the
ID literature — asymmetric decision problems (conditional
...
IDs and multi-agent extensions (MAIDs) — and the review of Bielza,
G{\'o}mez and Shenoy~\cite{bielza2011review} offers a thorough
catalogue of them. The present thesis deliberately restricts
...
expert. Even with these aids, however, the resulting judgements are
known to be systematically biased: the experimental psychology of
