...
analytical techniques~\cite{insua2005,bielza2002}. Within this broad
family, \emph{Influence Diagrams} (IDs)~\cite{howard2005influence,
koller2009pgm} have become a particularly compact graphical formalism:
...
illustration is the neonatal-jaundice ID of Bielza et
al.~\cite{bielza2000structural}: more than 8\,000 probability entries
and over a hundred utility values have to be elicited from clinicians
before the model can be put to use.
...
\begin{itemize}
    \item \textbf{Clinical decision support.}
          ...
          of~\cite{bielza2000structural} is a canonical example.
...
\begin{enumerate}
    ...
    \item Implement the resulting system on top of the
          ...
          neonatal-jaundice ID of~\cite{bielza2000structural} as the
          benchmark.
